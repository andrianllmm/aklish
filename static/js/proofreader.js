...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let textMarks = document.querySelector("#text-marks");
    ...
    showSuggestions.onclick = (event) => {
        ...
        document.querySelector("#suggestions-col").removeAttribute("hidden");
        hideSuggestions.removeAttribute("hidden");
    }

    hideSuggestions.onclick = (event) => {
        event.preventDefault();
        document.querySelector("#suggestions-col").setAttribute("hidden", true);
