...
urlpatterns = [
    ...
    path("edit/translation/<int:translation_id>/", views.edit_translation, name="edit_translation"),
    path("delete/translation/<int:translation_id>/", views.delete_translation, name="delete_translation"),
